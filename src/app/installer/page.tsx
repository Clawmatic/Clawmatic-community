          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto mb-16">
            <div className="rounded-xl border border-border/50 bg-card p-7">
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-xs px-2.5 py-1 rounded-full border border-primary/20 bg-primary/5 text-primary font-medium">Free</span>
              </div>
            ...
            <div className="rounded-xl border border-primary/20 bg-primary/5 p-7">
              <div className="flex items-center justify-between mb-5">
                ...
                <span className="text-xs px-2.5 py-1 rounded-full border border-primary/30 bg-primary/10 text-primary font-medium">Paid</span>
              </div>
              <ul className="space-y-3">
